...
- Ingredients and provenance appear in the existing native detail sheet. Generic foods are explicitly labeled representative, exact barcode matches are labeled exact, and stale cached records are labeled accordingly. Pricing is not available from these providers and stays absent.
