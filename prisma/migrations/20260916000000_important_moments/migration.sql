-- Important Moments tables. These shipped on main as SQLite migrations
-- (10_important_moments, 202609170001_festival_management), which now live in
-- prisma/sqlite/migrations. This is the Postgres equivalent, applied after the
-- 20260914000000_init baseline.

-- CreateTable
CREATE TABLE "ImportantMoment" (
    "festivalSettings" TEXT NOT NULL DEFAULT '{}',
    "id" TEXT NOT NULL,
