...
import { creationDateFor } from '../../src/lib/taskCreation';
import { useCreateTask, type ScheduleConflict } from '../../src/query/useTasks';
import { useConsent } from '../../src/store/consent';
import { useSession } from '../../src/store/session';
import { useTheme } from '../../src/theme';
import { startVoiceCaptureStub, type VoiceCaptureStub } from '../../src/voice/taskCaptureStub';
import { VOICE_PHASE_STATUS, type VoiceCapturePhase } from '../../src/voice/taskCaptureTypes';
  ...
  return (
    <View style={styles.fill}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <Text style={[styles.heading, { color: theme.colors.ink }]}>Speak your task</Text>
        ...
        {phase === 'idle' && added.length === 0 ? (
          <View style={styles.examples}>
            ...
            <Text style={[styles.body, { color: theme.colors.secondary }]}>“Call Damien tomorrow at 11 AM”</Text>
            <Text style={[styles.body, { color: theme.colors.secondary }]}>“Actually make that noon”</Text>
            <Text style={[styles.body, { color: theme.colors.secondary }]}>“That’s all”</Text>
          </View>
        ) : null}
      </ScrollView>
