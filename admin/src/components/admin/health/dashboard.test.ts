...
import { emptyHealth } from '../../../../test/fixtures';
...
it('renders missing telemetry, read-only controls and accessible statuses',()=>{
 vi.stubGlobal('React',React);
...
it('shows real Voice and Security statuses and explains low activity',()=>{
 vi.stubGlobal('React',React);
 const data=emptyHealth();
 data.enabled=true;
