...
@MainActor final class TaskActionCoordinator: ObservableObject {
    ...
    func activate(userID: String?) {
        ...
        owner = key; generation += 1; route = nil; actions = []; notice = nil; resolvedContacts = [:]
    ...
    func synchronize(tasks: [NexdoTask], userID: String) {
        ...
        actions = TaskActionReconciler.reconcile(previous: actions, tasks: tasks, detector: detector, now: Date(), timeZone: .current)
