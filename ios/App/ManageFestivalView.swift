...
@State private var aiConsent=false
    ...
    private var schedule:some View {Group{
        ...
        Text("\(automaticCount) automatic · \(model.selected.count-automaticCount) sent by you").font(.subheadline)
