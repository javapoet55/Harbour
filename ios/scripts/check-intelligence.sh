...
check_dir=$(mktemp -d /private/tmp/nexdo-intelligence.XXXXXX)
...
PY
"${DEVELOPER_DIR:-/Applications/Xcode.app/Contents/Developer}/Toolchains/XcodeDefault.xctoolchain/usr/bin/swiftc" \
  ...
  "$repo_root/ios/Tests/AppModelChecks/IntelligenceChecks.swift" \
  -o "$check_dir/checks"
"$check_dir/checks"
