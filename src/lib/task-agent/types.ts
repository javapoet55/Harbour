export type AgentSlots={location:string;locationConfirmed?:boolean;urgency:'urgent'|'flexible'|'unknown';budget:string;constraints:string;preferencesConfirmed:boolean};
