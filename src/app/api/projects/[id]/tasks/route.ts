...
async function healthHandlerGET(_request: Request, context: { params: Promise<{ id: string }> }) {
...
export const GET = healthRoute('GET /api/projects/[id]/tasks', healthHandlerGET);
