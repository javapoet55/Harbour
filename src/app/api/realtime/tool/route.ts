...
import { z } from 'zod';
const envelope = z.object({ consent: z.literal(true), sessionId: z.string().uuid(), callId: z.string().min(1).max(200), name: z.string().max(50), arguments: z.record(z.string(), z.unknown()) }).strict();
